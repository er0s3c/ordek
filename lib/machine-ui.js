...
// Panel origin: docker hedefinde (LAB_MACHINE set) flag/ilerleme panele raporlanır; panelde same-origin.
const PANEL_ORIGIN = (typeof process !== "undefined" && process.env && process.env.LAB_MACHINE)
  ? (process.env.PANEL_ORIGIN || "http://localhost:3000") : "";
